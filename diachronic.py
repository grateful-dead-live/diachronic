...
from hispeedfeatures import load_feature
from archive import get_song_versions_by_year
...
def load_and_join_features2(featurefiles):
...
def plot_song_versions(song, feature):
    ...
    plot_features(yearly_features, 'results/'+song+'_'+feature+'2.png')
